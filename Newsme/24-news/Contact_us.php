...
$_SESSION['alert_yes']= "";
    ...
    if (isset($_POST['send'])) {
       ...
       if (empty($name)) {
        ...
        $_SESSION['alert_no'] ="Name is Require ";

       }elseif (empty($email)) {
        $_SESSION['alert_no'] ="Email is Require ";
      }elseif (empty($subject)) {
    
        $_SESSION['alert_no'] ="Subject  is Require ";

      }elseif (empty($message)) {
    
        $_SESSION['alert_no'] ="Message  is Require ";
        ...
        $_SESSION['alert_yes'] ="Complete information Send ";
...
<head>
    ...
    <style>
     .contact_us_bg_img{
                background:url('../24-news/Signup/images/contact.jpg');
                padding:100px 0;
...
<div class="container-fluid contact_us_bg_img">
    <div class="container">
        ...
        <div class="row">
            <a href="home.php" class="fh5co_con_123"><i class="fa fa-home"></i></a>
            ...
            <div class="col-md-4 py-3">
                <div class="row fh5co_contact_us_no_icon_difh5co_hover">
                    ...
                    <div class="col-9 align-self-center fh5co_contact_us_no_icon_difh5co_hover_2">
                        ...
                        <span class="d-block c_g fh5co_contact_us_no_text">ar.salha@alaqsa.edu.ps</span>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
...
?>
                <form class="row" action="" method="POST" id="fh5co_contact_form">
                    ...
                    <div class="col-12 py-3 text-center"> <input type="submit" name="send" value="Send Message" class="btn contact_btn"> </div>
                </form>
            </div>
