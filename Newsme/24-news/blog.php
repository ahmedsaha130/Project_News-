...
<head>
<a href="../24-news/Login_v1/index.php"></a>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <div class="container paddding">
        <div class="row mx-0">
          ...
          ?>
                              ...
                              <a class="fh5co_magna py-2" href="single.php?id=<?php echo $row['id']?>"><?php echo $title ?></a>

                   
                                 
                                  </a> <a href="#" class="fh5co_mini_time py-3"> <?php echo $currentdate?> </a>
                                  <div class="fh5co_consectetur">
                                  <?php echo substr($descrption,1,200)."...........";?>
                                  </div>
                              </div>
                          </div>
    ...
    <div class="container">
        ...
        <div class="col-12 col-md-6 py-4 Reserved"> © Copyright 2021, All rights reserved. Design by <a href="#" title="Free HTML5 Bootstrap templates">Ahmed Salha</a>. </div>
            <div class="col-12 col-md-6 spdp_right py-4">
                ...
                <a href="single.php" class="footer_last_part_menu">About</a>
