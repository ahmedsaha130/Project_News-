...
session_start();
include '../24-news/consaintent/consaintent.php';
...
$currentdate ="";
  ...
  if ($rows>0) {
    ...
    $sql = " SELECT * FROM blog  ORDER BY currentdate DESC";
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 fh5co_mediya_center"><a href="#" class="color_fff fh5co_mediya_setting"><i
                    class="fa fa-clock-o"></i>&nbsp;&nbsp;&nbsp;<?php echo  $currentdate ?></a>
...
// where feature='feature' ORDER BY currentdate DESC
$sql = " SELECT * FROM blog ";
...
if ($rows>0) {
    ?>
     ...
     <a class="prev"  style="margin-top: 29%;margin-left: 3%;" onclick="plusSlides(-1)">❮</a>
    <?php
...
<div class="container" >
  <div class="mySlides">
    ...
    <img width="100%" height="50%"  src="../24-news/images/uploadimge/<?php echo $img ?>   " style=" margin-top:73px;">
...
<a style="margin-top: -21%;margin-inline-end: -5%;" class="next" onclick="plusSlides(1)">❯</a>
</div> 
   </div>
...
$sql = "SELECT * FROM blog where feature='feature' AND view='view'";
$query = mysqli_query($conect,$sql);
          ...
          ?>
            ...
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                   ...
                   <img src="../24-news/images/uploadimge/<?php echo $img?>" 
                   alt="" class="fh5co_img_special_relative"/>
                   <div class="fh5co_latest_trading_img_position_absolute_1">
                     <a href="single.php?id=<?php echo $row['id']?>" class="text-white"> <span style="background-color: #100c0cad"><?php echo $title ?> </span> </a>
                        <div class="fh5co_latest_trading_date_and_name_color"> <span style="background-color: #100c0cad"><?php echo $currentdate?></span></div>
                    </div>
                  </div>
...
$sql = "SELECT * FROM blog Where view ='view' ORDER BY currentdate DESC";
$query = mysqli_query($conect,$sql);
          ...
          ?>
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><img src="../24-news/images/uploadimge/<?php echo $img?>" alt=""></div>
                    <div>


                        <a href="single.php?id=<?php echo $row['id']?>" class="d-block fh5co_small_post_heading"><span class=""><?php echo $title?></span></a>
                        <div class="c_g"><i class="fa fa-clock-o"></i><?php echo $currentdate?></div>
                    </div>
                </div>
            </div>
            <?php        
    ...
    <div class="container">
        <div class="row  ">
            ...
            <div class="col-12 col-md-6 spdp_right py-4">
                <a href="home.php" class="footer_last_part_menu">Home</a>
